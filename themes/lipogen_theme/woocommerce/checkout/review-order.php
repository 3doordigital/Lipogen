...
<div class="col-md-7 order_conf">
	<table class="shop_table">
		<thead>
			<tr>
				<th class="product-name"><?php _e( 'Product(s)', 'woocommerce' ); ?></th>
...
<div class="form-row place-order">
		...
		<?php echo apply_filters( 'woocommerce_order_button_html', '<input type="submit" class="btn btn-primary" name="woocommerce_checkout_place_order" id="place_order" value="Process Order" data-value="Process Order" />' ); ?>
