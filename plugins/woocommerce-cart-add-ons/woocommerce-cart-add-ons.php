        ...
        if ($display_mode == 'loop') {
            ...
            <div class="sfn-cart-addons-images">
                <ul class="products sfn-cart-addons">
                    ...
                    if ($loop->have_posts()) : while ($loop->have_posts()) : $loop->the_post(); global $product;
                        $product = sfn_get_product(get_the_ID());
                        if ( !$product->is_visible() ) continue;
                        echo '<li style="text-align:center;"><a href="'. get_permalink($product->id) .'">'. woocommerce_get_product_thumbnail() .'</a><br/><a href="'. get_permalink($product->id) .'">'. $product->get_title() .'</a>';
            ...
            <div class="sfn-cart-addons-names">
                <ul class="products sfn-cart-addons">
                    ...
                    if ($loop->have_posts()) : while ($loop->have_posts()) : $loop->the_post(); global $product;
                        if ( !$product->is_visible() ) continue;
                        echo '<li><a href="'. get_permalink($product->id) .'">'. $product->get_title() .' '. woocommerce_price($product->get_price()) .'</a>';
